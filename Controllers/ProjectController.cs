...
namespace FinalProject.Controllers
{
    public class ProjectsController : Controller
    {
        ...
        public ProjectsController(FinalDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Details(string id)
        {
            ...
            var clients = 
                ...
                on participant.ID equals projectparticipant.ParticipantID
        ...
        public async Task<IActionResult> EditProjectParticipants(string id)
        {
            ...
            var uniqueclients = 
                ...
                on participant.ID equals projectparticipant.ParticipantID
                where participant.ID != projectparticipant.ParticipantID
                select participant;
            */                
        ...
        public async Task<IActionResult> DeleteProjectParticipant(string pid, string id)
        {
           ...
           //var project = await _context.Projects.SingleOrDefaultAsync(m => m.ID == id);
           var projectparticipant = await _context.ProjectRoster.SingleOrDefaultAsync(m => m.ProjectID == pid && m.ParticipantID == id );
